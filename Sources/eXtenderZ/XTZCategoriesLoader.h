...
@interface XTZCategoriesLoader : NSObject

/**
 This method can be used in order to prevent the need for the `-ObjC` flag.
 Call it before calling anything else in the library
  (before all the ``NSObject/xtz_registerClass:asHelptenderForProtocol:`` is probably the best place).
