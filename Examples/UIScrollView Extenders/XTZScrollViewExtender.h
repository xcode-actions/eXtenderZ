...
@protocol XTZScrollViewExtender <XTZExtender>
@optional

/* ***************************** */
/* *** Extentions on actions *** */

/* Called when the scroll view was scrolled.
 * Called _before_ the actual delegate is called. */
...
/* Gives the extender an opportunity to override the scroll destination when the user ends a scroll. */
...
@interface XTZScrollViewDelegateForHelptender : NSObject <UIScrollViewDelegate> {
@private
...
@interface XTZScrollViewHelptender : UIScrollView <XTZHelptender>

/* Can be overridden by sub-helptenders to return custom cheat delegate.
 * The following restrictions apply:
 *    - The cheat delegate must always be kind of class XTZScrollViewDelegateForHelptender;
...
/* If you provide your own cheat delegate in a sub-helptender, you should probably also override these… */
