 ...
 *    - (BOOL)prepareObjectForExtender:(XTZExtendedViewController *)viewController;
 *    - (void)prepareObjectForRemovalOfExtender:(XTZExtendedViewController *)viewController;
 *
 ...
 */
@interface XTZLinkedOE : NSObject <XTZExtender>
