...
@protocol XTZViewControllerExtender <XTZExtender>
@optional

/* Called in controller's viewDidLoad method.
 * May never be called if the extender is added after the view is loaded!
 * You can use the isViewLoaded property of the extended table view controller to know if it has loaded its view. */
...
@interface XTZViewControllerHelptender : UIViewController <XTZHelptender>
